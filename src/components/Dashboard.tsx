...
const Dashboard: React.FC = () => {
    ...
    const totalCredit = user_deta
        .filter((item: any) => item.cate === "credit")
        .reduce((prev: number, value: any) => prev + parseFloat(value.amount), 0);
    const totalDebit = user_deta
        .filter((item: any) => item.cate === "debit")
        .reduce((prev: number, value: any) => prev + parseFloat(value.amount), 0);
                            ...
                            <div>
                                ...
                                <Menu.Target>
                                    <Button
                                        variant="outline"
                                        color="black"
                                        style={{ margin: "0px 0.7rem" }}
                                    >
                                        User <IconChevronDown />
                                    </Button>
                                </Menu.Target>
                            </div>
                            <Menu.Dropdown>
                            ...
                            <div className="b1">
                                <div>
                                    ...
                                    <h1>
                                        ...
                                        {totalCredit - totalDebit + ".00"}
                                    </h1>
                                </div>
                                <p>
                                    <FontAwesomeIcon icon={faCircleUp} /> grow
                                </p>
                            </div>

                            <div className="b2">
                                <div>
                                    Total Income<h1>₹.{totalCredit + ".00"}</h1>
                                </div>
                            </div>
                            <div className="b2">
                                <div>
                                    Total Expenses<h1>₹.{totalDebit + ".00"}</h1>
                                </div>
                            </div>
                        </div>
